import Catalog from "@lib/carbonite/attachments/catalog";
import NotImageError from "@lib/carbonite/attachments/errors/not-image-error";
import {RGB} from "@lib/util/color";
import FileDescriptor, {Img} from "@lib/util/file-descriptor";
import {Dimension} from "@lib/util/geometry";
