...
function createUploadRoute(app, endpoint, uploadTokenKey, logger, uploadOptions, currentAuthorized, jwt) {
    app.use(endpoint, (0, check_file_token_middleware_1.default)(jwt, currentAuthorized), (0, upload_file_middleware_1.default)(logger, uploadOptions), (0, handle_file_middleware_1.default)());
}
