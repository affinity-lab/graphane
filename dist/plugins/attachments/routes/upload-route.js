...
function createUploadRoute(exp, endpoint, uploadOptions, currentAuthorized, jwt) {
    exp.use(endpoint, (0, check_file_token_middleware_1.checkFileTokenMiddleware)(jwt, currentAuthorized), (0, upload_file_middleware_1.uploadFileMiddleware)(uploadOptions), (0, handle_file_middleware_1.handleFileMiddleware)());
}
