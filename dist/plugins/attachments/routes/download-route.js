...
function downloadRoute(app, endpoint, fileStoragePath, fileMaxAge) {
    app.use(resolve_file_location_middleware_1.resolveFileLocationMiddleware.route(endpoint), express_1.default.Router({ mergeParams: true }).use((0, resolve_file_location_middleware_1.resolveFileLocationMiddleware)(), express_1.default.static(fileStoragePath, { maxAge: fileMaxAge }), (0, file_not_found_middleware_1.fileNotFoundMiddleware)()));
}
